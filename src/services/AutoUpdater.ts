...
export class AutoUpdater {
    ...
    public startPolling(intervalMs: number = 5 * 60 * 1000): void {
    ...
    public isBotIdle(): boolean {
        if (this.client.queues.size === 0) return true;
    ...
    public async onQueueFinished(): Promise<void> {
